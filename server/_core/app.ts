...
import { proxyEspnScoreboard, proxyEspnSummary } from "../espnProxy";
import { runDstSeasonStatsSync, runFantasyProsArchiveCollection, runNflTeamAssignmentSync, runTank01ScoringSync, runTeamScheduleSync, runWaiverResolution } from "./scheduledHandlers";
...
export function createApp(): Express {
  ...
  app.get("/api/scheduled/team-schedule-sync", runTeamScheduleSync);
  app.post("/api/scheduled/team-schedule-sync", runTeamScheduleSync);
  app.get("/api/scheduled/fantasypros-archive", runFantasyProsArchiveCollection);
  app.post("/api/scheduled/fantasypros-archive", runFantasyProsArchiveCollection);
