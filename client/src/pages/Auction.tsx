...
function CommissionerControls({ teams, recent }: { teams: any[]; recent: any[] }) {
  ...
  const [winnerId, setWinnerId] = useState(""); const [amount, setAmount] = useState("1"); const [correctionId, setCorrectionId] = useState(""); const [reason, setReason] = useState("");
