...
function LineupRow({ away, home, slot, points, live, profiles, injuryStatuses, projections, gameStatus }: { away: any; home: any; slot: string; points: (entry: any) => number | null; live: ReturnType<typeof useCvcTank01LiveScores>; profiles: Record<string, any>; injuryStatuses: ReturnType<typeof useCvcInjuryStatuses>; projections: ReturnType<typeof useCvcNFLProjections>["projections"]; gameStatus: NflGameStatusMap }) {
  ...
  const injuryFor = (entry: any) => entry?.player && !isDst(entry.player.position) ? injuryStatuses.get(normalizePlayerName(entry.player.display_name)) : undefined;
