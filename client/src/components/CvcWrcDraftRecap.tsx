  ...
  return <section className="mt-5 overflow-hidden rounded-xl border border-white/10 bg-white text-cvc-deep shadow-[0_8px_24px_rgba(0,0,0,0.16)]">
    ...
    <div className="p-5">
      ...
      <div className="grid gap-3 sm:grid-cols-[1fr_auto]">
        ...
        <button disabled={!correctionId || correct.isPending} onClick={() => { if (window.confirm("Correct this rookie draft selection? The player will be released and the pick reopened.")) correct.mutate({ draftPickId: correctionId }); }} className="rounded-lg border border-red-300 bg-red-50 px-4 py-2 text-xs font-black uppercase tracking-[0.1em] text-red-700 disabled:cursor-not-allowed disabled:opacity-50">{correct.isPending ? "Correcting…" : "Undo selection"}</button>
      </div>
