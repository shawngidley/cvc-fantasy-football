...
function SectionTable({ group, profiles, live, rules, slots, pendingSlots, onStageSlot, canEdit }: { group: CvcLineupGroup; profiles: Record<string, Tank01Profile | null>; live: ReturnType<typeof useCvcTank01LiveScores>; rules: CvcScoringRule[]; slots: any[]; pendingSlots: Record<string, string>; onStageSlot: (assignmentId: string, slotCode: string) => void; canEdit: boolean }) {
