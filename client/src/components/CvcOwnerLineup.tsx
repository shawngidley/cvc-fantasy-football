...
function SectionTable({ group, profiles, injuryStatuses, live, projections, slots, pendingSlots, onStageSlot, canEdit, isCommissioner }: { group: CvcLineupGroup; profiles: Record<string, Tank01Profile | null>; injuryStatuses: ReturnType<typeof useCvcInjuryStatuses>; live: ReturnType<typeof useCvcTank01LiveScores>; projections: CvcProjectionMap; slots: any[]; pendingSlots: Record<string, string>; onStageSlot: (assignmentId: string, slotCode: string) => void; canEdit: boolean; isCommissioner: boolean }) {
